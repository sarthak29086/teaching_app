    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          {/* Quick Links - Now with working navigation */}
          <div className="rounded-2xl bg-slate-900/70 border border-slate-800/50 p-6">
            ...
            <div className="space-y-3">
              ...
              <button className="w-full flex items-center gap-3 p-3 rounded-xl bg-slate-800/30 hover:bg-slate-800/50 border border-transparent hover:border-slate-700/50 transition-all text-left">
                <span className="text-xl">📚</span>
                <div>
              ...
              <button className="w-full flex items-center gap-3 p-3 rounded-xl bg-slate-800/30 hover:bg-slate-800/50 border border-transparent hover:border-slate-700/50 transition-all text-left opacity-50 cursor-not-allowed">
                <span className="text-xl">📝</span>
                <div>
